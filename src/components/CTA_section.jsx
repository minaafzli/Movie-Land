...
function CTA_section() {
  ...
  return (
    <div className=' md:px-[50px] bg-secondary pt-20 pb-10'>
      <div
        className="h-auto py-10 bg-cover font-[inter] rounded-xl flex justify-center items-center"
        style={{ backgroundImage: `url(${cta_bg})` }}
      >
        <div className='p-10 flex flex-col items-center'>
          <p className='text-2xl md:text-4xl font-bold text-accent text-center'>
            Unlock Your Cinematic Experience! Ready to Dive Into Movie Magic
          </p>
          <p className='text-muted font-bold text-center pt-4  text-md md:text-lg'>
