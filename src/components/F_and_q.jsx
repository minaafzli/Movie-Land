...
function F_and_q() {
    return (
       ...
       <p className="text-muted w-[770px] pb-8">Check out our Frequently Asked Questions section for everything you need to know about your movie streaming experience.</p>
